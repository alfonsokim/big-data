...
#---------------------------------------------------------------------------------------------------------------
# Generar el esquema de los datos
...
# Crear el dataset en el hive metastore.
...
# Corremos el agente de flume
# NOTA: Preferímos usar un sink en Avro directo al HDFS.

flume-ng agent -n GDELTAgent -Xmx300m --conf flume -f flume/gdelt-agent.conf

# Abrir otra conexión al contenedor
docker exec -it hadoop-pseudo-proyecto /bin/zsh
su itam

# Correr el código que baja los datos y los mete al spoolDir
